...
<form:form action="${pages}" commandName="filter">
    <td>
        <form:select path="entriesPerPage" size="1" onchange="if (this.selectedIndex) this.form.submit()">
            <option value="${filter.entriesPerPage}">${filter.entriesPerPage}</option>
            <option value="5">5</option>
            <option value="10">10</option>
            <option value="20">20</option>
            <option value="${pagesCount*filter.entriesPerPage}">all</option>
        </form:select>
    </td>
